...
public class TrainingDataGenerator {
	...
	public static void main(String[] args) throws Exception {
        ...
        try {
            Transcriptome tr = new Transcriptome(gg.read("/home/volta/another/diploma/bowtie/Trinity.fasta", "fasta"));
            Transcriptome tr2 = new Transcriptome(gg.read("/home/volta/another/diploma/bowtie/Oases.fa", "fasta"));
