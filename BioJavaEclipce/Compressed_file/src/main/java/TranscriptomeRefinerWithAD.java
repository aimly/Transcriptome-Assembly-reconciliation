...
public class TranscriptomeRefinerWithAD implements TranscriptomeRefiner {
	...
	public Transcriptome refiner(Transcriptome transcriptome1,
		...
		Transcriptome MLtr = ad.getGoodTranscripts (trAssignment1,
				trAssignment2,
				tr1,
				tr2,
				topBound,
